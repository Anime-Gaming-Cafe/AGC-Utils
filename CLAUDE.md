...
- **User-facing strings are German; code and comments are English.** Keep new comments sparse and only where the logic is non-obvious. Please Avoid comments in the code. Really dont so unneccessary comments
