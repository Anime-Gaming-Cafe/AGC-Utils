...
public partial class Perms
{
    ...
    [
        ...
        ("Auto-Revoke",
            ...
            "``/perms settings auto-revoke:True``\n\n" +
        ...
        ("Manuelle Overrides",
            ...
            "``/perms grant member:@User permission:media reason:Sonderfall``\n" +
            "``/perms revoke member:@User permission:media reason:Missbrauch``\n" +
            "``/perms reset member:@User permission:media``\n\n" +
            ...
            "``/perms info member:@User`` zeigt für ein Mitglied alle Permissions, den " +
        ...
        ("Szenario 5: Veteran, einmal und für immer",
            ...
            "``/perms reset member:@User permission:veteran rearm-trigger:True``"),
    ...
    public static async Task Guide(InteractionContext ctx)
    {
        ...
        DiscordEmbedBuilder BuildEmbed(int index)
        {
            ...
            return new DiscordEmbedBuilder
            {
                ...
                {
                    Text = $"Kapitel {index + 1}/{GuideChapters.Length} · /perms guide"
                }
            };
        }
